...
The easy fix is to add a Docker environment variable to the Better NPM stack:
...
For reference, the default configuration can be found [here](https://github.com/snxRCS/better-npm/blob/main/docker/rootfs/etc/logrotate.d/nginx-proxy-manager).
