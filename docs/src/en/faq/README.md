...
[not listed](https://github.com/snxRCS/better-npm/pkgs/container/better-npm) please open a
[GitHub issue](https://github.com/snxRCS/better-npm/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=).
...
Better NPM itself), most likely the app will also use the `Authorization` header to transmit this information,
